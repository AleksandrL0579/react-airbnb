...
function App() {
  const data = {
    ...
    additional_properties: {
      ...
      host_languages: ["English", " , ", "Spanish", " , ", "Chinese"],
  ...
  return (
    <Page>
      ...
      />
      <Photo src={data.image} alt={data.listing_name} />
      <Price
      ...
      <Description title="Описание" children={data.description} />
      ...
      <Additional
        ...
        in_instructions={data.additional_properties.in_instructions}
      />

      <Reviews list={data.guestReviews} />

      <Entertainment list={data.nearbyAttractions} />
    </Page>
  );
}
